...
class EvaluationC4Seeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Questionnaire::insert([
            [
                'section_id' => 7,
                'name' => 'Accuracy of Board and Committee meeting minutes.'
            ],
            [
                'section_id' => 7,
                'name' => 'Quality of agenda line up for the scheduled Board / Committee meeting.'
            ],
            [
                'section_id' => 7,
                'name' => 'Timely distribution of Board and Committee folders.'
            ],
            [
                'section_id' => 7,
                'name' => 'Mastery of the provisions of the Amended By-laws.'
            ],
            [
                'section_id' => 7,
                'name' => 'Familiarity with past resolutions and matters of discussion by the Board.'
            ],
            [
                'section_id' => 7,
                'name' => 'Quality of legal advice given to the Board as needed*'
            ],
            [
                'section_id' => 7,
                'name' => 'Familiarity with laws and regulations that govern the operations of AFPSLAI as an NSSLA.'
            ],
            [
                'section_id' => 7,
                'name' => 'Efficiency in handling annual BOT assessments.'
            ],
            [
                'section_id' => 7,
                'name' => 'Handling of proceedings during Annual Membership Meetings.'
            ],
            [
                'section_id' => 7,
                'name' => 'Handling of records of Board and Committee meetings.'
            ],
            [
                'section_id' => 7,
            ...
            [
                'section_id' => 7,
                'name' => 'Level of clarity of understanding on the role of the Corporate Secretary.'
            ],
        ]);
