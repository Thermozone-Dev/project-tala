    ...
    public function run(): void
    {
        ...
        DB::table('rating_scale_values')->insert([
            ...
            [
                'id' => 7,
                'rating_scale_id' => 2,
                'name' => '40% to less than 60% of the time',
                'value' => 2,
                'qualitative' => 'Good',
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                'id' => 8,
                'rating_scale_id' => 2,
                'name' => '60% to less than 80% of the time',
                'value' => 3,
                'qualitative' => 'Very Good',
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                'id' => 9,
                'rating_scale_id' => 2,
                'name' => '80% to less than 100% of the time',
                'value' => 4,
                'qualitative' => 'Superior',
                'created_at' => now(),
                'updated_at' => now(),
