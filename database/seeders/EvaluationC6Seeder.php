...
class EvaluationC6Seeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Questionnaire::insert([
            [
                'section_id' => 11,
                'name' => 'Mastery of the financial records of the Association.'
            ],
            [
                'section_id' => 11,
                'name' => 'Ability to communicate financial information in a manner that can be easily understood by the Board.'
            ],
            [
                'section_id' => 11,
                'name' => 'Familiarity with past resolutions and matters of discussion by the Board on matters relating to the financial affairs of the Association.'
            ],
            [
                'section_id' => 11,
            ...
            [
                'section_id' => 11,
                'name' => 'Familiarity with laws and regulations that govern the reporting and management of financial affairs of the Association.'
            ],
            [
                'section_id' => 11,
            ...
            [
                'section_id' => 11,
                'name' => 'Level of clarity of understanding on the role of the Corporate Comptroller.'
            ],
        ]);
