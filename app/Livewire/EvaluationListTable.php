        ...
        return $table
            ...
            ->recordActions([
                Action::make('view_evaluation')
                    ...
                    ->icon('heroicon-o-eye')
                    ->url(fn ($record) => EvaluationPeriodResource::getUrl('evaluation-trustee',['record' => $record->active_evaluation->first()->evaluation_id, 'evaluator_id' => $record->user_id]) ),

                    // ->url(fn ($record) => EvaluationPeriodResource::getUrl('evaluation-trustee',['record' => $record->active_evaluation->first(), 'evaluator_id' => $record->user_id]) ),
            ])
            ->toolbarActions([
