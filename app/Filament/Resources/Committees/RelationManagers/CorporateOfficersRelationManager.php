        ...
        return $table
            ...
            ->recordActions([
                Action::make('toggle_active')
                    ...
                    ->requiresConfirmation(),
                // ViewAction::make(orize(check_committee_permission($this->getOwnerRecord()->id,'View:Committee'))
                //     ->url(fn (Model)->auth $record) => CommitteeResource::getUrl('evaluation-periods', ['record' => $this->getOwnerRecord()->id,'evaluator_id' => $record->user_id])),
