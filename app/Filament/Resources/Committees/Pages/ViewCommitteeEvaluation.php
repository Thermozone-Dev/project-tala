...
class ViewCommitteeEvaluation extends Page implements HasForms, HasTable
{
    ...
    public function getFormSchema(): array
    {
        ...
        return [
            Grid::make(1)->schema(AssessmentEvaluationFields::run($view_record->ef_id,$this->record_id,$this))
                ->disabled(fn () => ! auth()->user()->hasAnyRole(['Super Admin', 'Secretariat']) && ! $eval_status),
